...
<html lang="en">
	<head>
		...
		<!-- Site Logo -->
		<link href = "../images/design/logo.jpg" rel="icon" type="image/jpg">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<div class="col-md-3 col-sm-3 col-xs-12 profile_left">
							<h3 align="center"><i class="fa fa-money"></i> Money Detail</h3>

							<ul class="list-unstyled user_data">
								<li>
								<i class="fa fa-clock-o user-profile-icon"></i>Total Hire Time :  <?php $durationinhours = $rowgetbooking['durationinhours']; echo $durationinhours;?> Hours
								</li>
								<li>
